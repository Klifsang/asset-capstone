...
from endpoints.admin_api import delete_admin, patch_admin, register_admin, get_admin
...
app.add_url_rule('/api/staff/get', 'get_employees', get_employees, methods=['GET'])
...
app.add_url_rule('/api/assets/get', 'get_assets', get_assets, methods=['GET'])
